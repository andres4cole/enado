  ...
  <!-- general form elements -->
              <div class="box box-solid">
                <div class="box-header with-border">
                 ...
                 <!-- form start -->
    <form role="form" method="Post" action="{{ url('/admin/sliders/'.$slider->id.'/update') }}" enctype="multipart/form-data" id="form" >
     <div class="box-body">
     	   ...
     	   <input type="hidden" name="_token"  value="{{ csrf_token() }}" >
				  ...
				  <div class="form-group {{{ $errors->has('name') ? 'has-error' : '' }}} ">
                      ...
                      <input type="text" id="name" class="form-control" name="name"  placeholder="name" value="{{ $slider->name }}">
                      ...
                      <textarea name="description" id="description" class="form-control" rows="3" col="10"  placeholder="Enter ..." style="height: 300px">{{ $slider->description }}</textarea>
                  ...
                  <div class="form-group {{{ $errors->has('background') ? 'has-error' : '' }}}">
                    <div class="btn btn-default btn-file">
                      ...
                      <input type="file" name="background" id="background" value="{{ old('background')}}" />

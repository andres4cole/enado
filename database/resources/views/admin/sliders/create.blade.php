  ...
  <!-- general form elements -->
              <div class="box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">create sliders</h3>
                </div><!-- /.box-header -->
                 <!-- form start -->
    <form role="form" method="Post" action="{{ url('/admin/sliders/store') }}" enctype="multipart/form-data" id="form" >
     <div class="box-body">
         ...
         <input type="hidden" name="_token"  value="{{ csrf_token() }}" >
          ...
          <div class="form-group {{{ $errors->has('name') ? 'has-error' : '' }}} ">
              ...
              <div class="form-group  {{{ $errors->has('description') ? 'has-error' : '' }}}">
                      ...
                      <textarea name="description" id="description" class="form-control" rows="3" col="10"  placeholder="Enter ..." style="height: 300px">{{ old('description')}}</textarea>

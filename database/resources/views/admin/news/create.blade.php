             ...
             <div class="col-md-6">
              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                 ...
                 <!-- form start -->
                <form role="form" method="Post" action="{{ url('/admin/news/store') }}" enctype="multipart/form-data" id="form" >
                  <div class="box-body">
                   ...
                   <input type="hidden" name="userid"  value="{{ Auth::user()->id }}" >
                    ...
                    <textarea class="form-control" col="10" row="5"  name="news" id="new" placeholder="main news" value="" required="required"> {{ old('news') }}</textarea>
                 ...
                 <textarea class="form-control" col="5" row="5"  name="summary" id="summary" placeholder="main summary" value="" required="required"> {{ old('summary') }}</textarea>
